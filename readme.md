...
If you want, you can test this app in lightning studios via this [link]([https://lightning.ai/maxidiazbattan/studios/agentic-rag-llamaindex-ollama](https://lightning.ai/maxidiazbattan/studios/langgraph-agenticrag-with-streamlit?section=mine)), or locally following the steps below.
